...
export class CreatecustomerComponent implements OnInit {
  ...
  constructor(private dbservice: DbserverserviceService, private route: Router, private activeRoute: ActivatedRoute) {
  ...
  states: any[] = [{"code": "AN","name": "Andaman and Nicobar Islands"},
